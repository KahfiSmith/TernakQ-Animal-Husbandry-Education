...
@section('content')
    <main class="flex flex-col space-y-6 w-full" x-data="{
        ...
        <div class="flex flex-col p-4 sm:p-6 bg-white shadow sm:rounded-lg ring-2 ring-gray-700 border-b-gray-200">
            ...
            <form method="POST"
                :action="editMode ? '{{ url('/admin/add-article-detail') }}/' + articleId :
                    '{{ route('admin.user-article-detail.store') }}'"
                ...
                <div class="flex flex-col space-y-1">
                    ...
                    <select id="card_id" name="card_id" x-model="cardId"
                        ...
                        <option value="">-- Pilih Artikel Grup --</option>
                ...
                <div class="flex flex-col space-y-1">
                    ...
                    <div class="relative">
                        ...
                        <div id="tags-dropdown" style="display: none;"
                            class="absolute w-full mt-1 bg-white border-2 border-gray-300 rounded-md shadow-lg z-10">
                            @foreach ($tags as $tag)
                                <label class="block px-4 py-2 text-gray-700 hover:bg-gray-100 cursor-pointer">
                                    <input type="checkbox" name="tags[]" value="{{ $tag->id }}" x-model="tags"
                                        class="mr-2">
                                    {{ $tag->name }}
                                </label>
                            @endforeach
        ...
        <div class="flex space-x-6 items-center justify-between">
            <div>
                <a href="{{ route('admin.add-article-sub') }}" wire:navigate
