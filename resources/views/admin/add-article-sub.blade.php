        ...
        <nav class="text-sm text-gray-600 font-medium" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="{{ route('admin.add-article') }}" class="text-gray-500 hover:text-gray-700 hover:underline">Grup
                        Artikel</a>
                </li>
                <li>
                ...
                <li class="inline-flex items-center">
                    <a href="{{ route('admin.add-article-detail') }}"
                    ...
                    <form method="POST"
                        ...
                        <div id="sub-articles-container">
                            <div class="sub-article-item ring-2 ring-gray-700 rounded-lg p-6 mb-6 relative">
                                ...
                                <x-input-error :messages="$errors->get('sub_articles.0.title')" class="mt-2 mb-4" />
                                <label class="block font-medium text-sm text-gray-700 mb-3">
                                ...
                                <x-input-error :messages="$errors->get('sub_articles.0.content')" class="mt-2 mb-4" />
                                ...
                                <input type="number" name="sub_articles[0][order_number]"
                                    ...
                                    text-gray-700 leading-5 transition duration-150 ease-in-out block mt-1 w-full py-2.5 mb-6"
                                    placeholder="Urutan">
                                <x-input-error :messages="$errors->get('sub_articles.0.order_number')" class="mt-2 mb-4" />
