...
<div
    class="flex flex-col ring-2 ring-gray-700 shadow-md overflow-hidden group cursor-pointer relative rounded-md
            h-full min-h-[420px]">
    ...
    <div class="flex justify-end px-4 py-3 mt-auto">
        <a href="#" class="flex space-x-2 items-center text-sm">
