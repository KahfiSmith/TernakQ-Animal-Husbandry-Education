    ...
    <a href="{{ route('articles.detail', ['id' => $article->id]) }}" class="flex flex-col justify-between">
        <div class="flex mb-8 space-x-6 h-full">
            <img src="{{ asset('storage/' . $article->image) }}" alt="Image"
                class="w-[200px] h-[180px] rounded-md mr-4 object-cover ring-2 ring-gray-300">
            <div class="flex flex-col w-full">
                ...
                <span
                    class="leading-snug min-h-12 tracking-wide mb-2">{{ Str::limit($article->description, 120) }}</span>
