<section id="tentang-kami" class="flex justify-between items-center px-14 mb-20">
        ...
        <div class="flex space-x-8">
            <div class="flex flex-col">
                <div class="flex items-center">
                    <span class="font-semibold text-4xl">45</span>
            ...
            <div class="flex flex-col">
                <div class="flex items-center">
                    <span class="font-semibold text-4xl">90</span>
                    <span class="font-medium text-2xl">+</span>
                </div>
